...
class CustomSpeechModelsApi(object):
    ...
    def copy_model_to_subscription_with_http_info(
        self, id, model_copy, **kwargs
    ):  # noqa: E501
        """Copies a model from one subscription to another.  # noqa: E501
        ...
        if self.api_client.client_side_validation and (
            "model_copy" not in params or params["model_copy"] is None
        ):  # noqa: E501
            raise ValueError(
                "Missing the required parameter `model_copy` when calling `copy_model_to_subscription`"
            )  # noqa: E501
    ...
    def create_model_with_http_info(self, model, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ValueError(
                "Missing the required parameter `model` when calling `create_model`"
            )  # noqa: E501
    ...
    def update_model(self, id, model_update, **kwargs):  # noqa: E501
        ...
        kwargs["_return_http_data_only"] = True
        if kwargs.get("async_req"):
            return self.update_model_with_http_info(
                id, model_update, **kwargs
            )  # noqa: E501
        else:
            (data) = self.update_model_with_http_info(
                id, model_update, **kwargs
            )  # noqa: E501
            return data
    ...
    def update_model_with_http_info(self, id, model_update, **kwargs):  # noqa: E501
        ...
        if self.api_client.client_side_validation and (
            "model_update" not in params or params["model_update"] is None
        ):  # noqa: E501
            raise ValueError(
                "Missing the required parameter `model_update` when calling `update_model`"
            )  # noqa: E501
